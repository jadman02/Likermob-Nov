...
if (position < (stop-1)) {$$( ".page-content" ).addClass( "page-content-scroll" );$$('.page-content').scrollTop($$('#listmarker').offset().top - 50, 300);}
if (position == (stop-1)) {$$( ".page-content" ).removeClass( "page-content-scroll" );$$('.page-content').scrollTop($$('#listmarker_end').offset().top - 50, 300);}
