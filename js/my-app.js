...
var myList = myApp.virtualList('.list-block.virtual-list', {
    ...
    renderItem: function (index, item) {
        return '<li class="item-content virtual-content">' +
                  '<div class="item-media" style="max-width:40px;overflow:hidden;padding-right:10px;"><img src="http://graph.facebook.com/'+item.page_id+'/picture?width=30&height=30" style="border-radius:50%;"/>' +
