...
'<div class="swipeout-content">'+
   ...
   '<div class="content-block" id="content-block" style="margin-top:-1px;clear:both;">'+
     ' <div class="content-block-inner" style="padding-bottom:41px;height:100%;background-color:hsla(0, 0%, 100%, 0.8);">'+


'<div class="messages-date">Sunday, Feb 3 <span>11:58</span></div>'+ 

'<div class="row">'+
        '<div class="col-20" style="height:100px;"><a href="#" onclick="getBusiness(\''+ response[i][1]  +'\');" style="z-index:100;margin:0 auto;border:0;background-color:transparent;margin-left:-10px;margin-top:10px;" class="button"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=30&height=30" style="border-radius:50%;"/></a></div>'+
