...
'<div id="map-canvas"></div>' +
	...
	'<div class="list-block media-list" style="margin-top:-20px;"><ul style="background-color:hsla(0, 0%, 100%, 0.8);"><li style="background-color:#3b5998;color:white;" onclick="openLikez()"><div class="item-content" style="background-color:transparent"><div class="item-media"><i class="pe-7s-like2 pe-lg"></i> Liked</div><div class="item-inner" style="border:0;"><div class="item-title-row"><div class="item-title"></div><div class="item-after"><div id="after-liked" class="badge"></div></div></div></div></div></li><div id="like-deals-here"></div></ul></div>' +
