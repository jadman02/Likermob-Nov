...
'<div id="map-canvas"></div>' +
	...
	'<div class="list-block media-list" style="margin-top:-20px;"><ul style="background-color:hsla(0, 0%, 100%, 0.8);"><li style="background-color:#3b5998;color:white;" onclick="openLikez()"><div class="item-content" style="background-color:transparent"><div class="item-media"><div id="after-liked" class="badge"></div></div><div class="item-inner" style="border:0;"><div class="item-title-row"><div class="item-title"><i class="pe-7s-like2 pe-lg"></i></div><div class="item-after"><i class="pe-7s-expand1" style="color:white;"></i></div></div></div></div></li><div id="like-deals-here"></div></ul></div>' +

	'<div class="list-block media-list" style="margin-top:-20px;"><ul style="background-color:hsla(0, 0%, 100%, 0.8);"><li style="background-color:#ff8000;color:white;" onclick="openLikex()"><div class="item-content"><div class="item-media"><div id="after-notliked" class="badge"></div></div><div class="item-inner" style="border:0;"><div class="item-title-row"><div class="item-title"><i class="pe-7s-like2 pe-lg pe-rotate-180"></i></div><div class="item-after"><i class="pe-7s-expand1" style="color:white;"></i></div></div></div></div></li><div id="deals-here"></div></ul></div>' +
