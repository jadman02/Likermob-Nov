...
if (position < (stop-1)) {$$( '#result' ).append('<li id="listmarker" style="height:10px;background-color:black;width:100px;"></li>');$$( ".page-content" ).removeClass( "page-content-scroll" );}
