...
'<div id="map-canvas"></div>' +
	...
	'<div class="list-block media-list"><ul><li style="background-color:#3b5998;color:white;"><div class="item-content" style="background-color:hsla(0, 0%, 100%, 0.8);"><div class="item-media"><i class="pe-7s-like2 pe-lg"></i></div><div class="item-inner" style="border:0;"><div class="item-title">Deals I Like</div></div></div></li><div id="like-deals-here"></div></ul></div>' +

	'<div class="list-block media-list"><ul><li style="background-color:#ff8000;color:white;"><div class="item-content" style="background-color:hsla(0, 0%, 100%, 0.8);"><div class="item-media"><i class="pe-7s-like2 pe-lg pe-rotate-180"></i></div><div class="item-inner" style="border:0;"><div class="item-title">Deals I Don\'t Like</div></div></div></li><div id="deals-here"></div></ul></div>' +
