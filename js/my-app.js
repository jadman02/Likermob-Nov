...
'<div style="float:left;font-size:14px;margin-left:10px;margin-top:15px;color:white;"><i class="pe-7s-like2 pe-lg" style="margin-right:2px;color:#3b5998;"></i>'+ response[i][17] + '<i class="pe-7s-like2 pe-lg pe-rotate-180" style="color:#ff8000;margin-left:5px;margin-right:2px;"></i>'+ response[i][18] + '</div>'+
