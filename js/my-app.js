...
'<div class="tab-links">'+
'<a href="#" id="commentloader" class="tab-link hide" style="border:0;height:40px;width:40px;margin:0 auto;background-color:transparent;margin-top:20px;"><i class="pe-7s-refresh pe-spin pe-2x"></i></a>'+
'<a href="#" id="chatloader" onclick="getComments();" style="z-index:100;height:40px;width:40px;margin:0 auto;border-radius:50%;background-color:transparent;margin-top:20px;" class="tab-link"><i class="pe-7s-chat pe-2x" style="margin-left:-2px;margin-top:5px;"></i></a>'+
 '<a href="#" id="chatloader" onclick="getComments();" style="z-index:100;height:40px;width:40px;margin:0 auto;border-radius:50%;background-color:transparent;margin-top:20px;" class="tab-link"><i class="pe-7s-comment pe-2x" style="margin-left:-2px;margin-top:5px;"></i></a>'+
...
function moveHomeimage(){
	...
	var positionimage = height_image - 21;
