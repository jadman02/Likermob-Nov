...
'<div class="imagediv" style="margin:0 auto;" onclick="makeComment();">'+
  ...
  '<a href="#" onclick="makeComment();" style="height:60px;width:60px;border-radius:50%;margin:0 auto;background-color:hsla(0, 0%, 100%, 0.5);" class="button"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=50&height=50" style="border-radius:50%;"/></a>'+
//openBrowser();
