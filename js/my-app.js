...
var url = 'http://smilesavers.net.au/images/compressed/'+response[0][1]+'_'+response[0][21]+'.jpg';
	...
	myApp.modal({
    title: '<img src="http://graph.facebook.com/'+page_id+'/picture?width=30&height=30" style="float:left;border-radius:50%;max-width:30px;"/><i class="pe-7s-star pe-lg" style="float:right"></i>',
