...
var favEntries = JSON.parse(localStorage.getItem("favEntries"));
if(favEntries == null) favEntries = [];
var staryellow = '<a href="#" onclick="removefavList(\''+ page_id  +'\',\''+ post_id  +'\')" id="yellow_'+ post_id +'" style="z-index:100;height:40px;width:40px;border:0;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x" style="color:#ffcc00;"></i></a>';
var starblue = '<a href="#" onclick="favList(\''+ page_id  +'\',\''+ post_id  +'\',\''+ name  +'\')" id="blue_'+ post_id +'" style="z-index:100;height:40px;width:40px;border:0;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x"></i></a>';
