...
var favEntries = JSON.parse(localStorage.getItem("favEntries"));
if(favEntries == null) favEntries = [];
var staryellow = '<a href="#" onclick="removefavList(\''+ page_id  +'\',\''+ post_id  +'\')" id="yellow_'+ post_id +'" style="padding-top:10px;z-index:100;border:0;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x" style="color:#ffcc00;"></i></a>';
var starblue = '<a href="#" onclick="favList(\''+ page_id  +'\',\''+ post_id  +'\',\''+ name  +'\')" id="blue_'+ post_id +'" style="padding-top:10px;z-index:100;border:0;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x"></i></a>';

if(favEntries.length > 0){for (j = 0; j < favEntries.length; j++) {if (favEntries[j].page_id == page_id){staryellow = '<a href="#" onclick="removefavList(\''+  page_id  +'\',\''+ post_id  +'\')" id="yellow_'+ post_id +'" style="padding-top:10px;z-index:100;border:0;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x" style="color:#ffcc00;"></i></a>';starblue = '<a href="#" id="blue_'+ post_id +'" onclick="favList(\''+ page_id  +'\',\''+ post_id  +'\',,\''+ name  +'\')" style="padding-top:10px;z-index:100;border:0;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x"></i></a>';}}}
