...
'<div style="float:left;font-size:14px;margin-top:-30px;"><i class="pe-7s-clock pe-lg"></i> Expires in 6 days</div>'+
'<div style="float:right;font-size:14px;margin-top:-30px;"><i class="pe-7s-like2 pe-lg"></i>'+ response[i][17] + '<i class="pe-7s-like2 pe-lg pe-rotate-180"></i>'+ response[i][18] + '</div>'+
