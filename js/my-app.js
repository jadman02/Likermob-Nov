...
if (position < (stop-1)) {$$( '#result' ).append('<li id="listmarker" style="width:100%;margin-left:5px;margin-right:5px;margin-bottom:5px;"><div style="height:5px;background-color:#007aff;float:left;width:'+ percentage +'%;"></div><div style="height:5px;background-color:#ccc;float:left;width:'+ minuspercentage +'%;"></div></li>');$$( ".page-content" ).removeClass( "page-content-scroll" );}
