...
document.getElementById("profilepic").innerHTML = '<img class="picture" src="http://graph.facebook.com/' + uid + '/picture?type=normal" style="margin:0 auto;text-align:center;width:80px;border-radius:50%;"/>';
