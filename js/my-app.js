...
if (position < (stop-1)) {$$( '#result' ).append('<li id="listmarker" style="width:100%"><div style="height:10px;background-color:black;width:100px;></div></li>');$$( ".page-content" ).removeClass( "page-content-scroll" );}
