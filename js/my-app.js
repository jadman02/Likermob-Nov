...
document.getElementById("commentpic").innerHTML = '<img src="http://graph.facebook.com/' + uid + '/picture?type=small" style="margin:0 auto;text-align:center;width:80px;border-radius:50%;"/>';
