...
'<div style="float:left;font-size:14px;margin-left:10px;margin-top:15px;"><i class="pe-7s-like2 pe-lg" style="margin-right:2px;color:#3b5998;"></i><span style="color:#e5e5ea;">'+ response[i][17] + '</span><i class="pe-7s-like2 pe-lg pe-rotate-180" style="color:#ff8000;margin-left:5px;margin-right:2px;"></i><span style="color:#e5e5ea;">'+ response[i][18] + '</span></div>'+
