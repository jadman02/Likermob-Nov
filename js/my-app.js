...
'</a>'+
   '<div class="content-block" id="content-block" style="margin-top:9px;clear:both;">'+
     ...
     '<div id="dealtitle" style="float:left;"><b>'+ response[i][3] + '</b></div><div style="float:right;font-size:14px;"><i class="pe-7s-cloud-upload pe-lg"></i> 6 minutes ago</div><br/><div>'+response[i][4]+'</div>'+
