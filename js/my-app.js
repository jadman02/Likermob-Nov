...
function likeButton(post_id,expiry,page_id,photo,title) {
getList();
like(post_id);
addEntry(post_id,expiry,page_id,photo,title);
var uid = localStorage.getItem("uid");
...
function addEntry(post_id,expiry,page_id,photo,title) {
var d = new Date();
