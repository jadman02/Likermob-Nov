...
'<div class="imagediv" onclick="makeComment();" style="margin:0 auto;">'+
...
'</a>'+
   '<div class="content-block" id="content-block" style="margin-top:10px;">'+
     ...
     '<div id="dealtitle" style="float:left;"><b>'+ response[i][3] + '</b></div><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=30&height=30" style="float:right;border-radius:50%;"/><br/><div>'+response[i][4]+'</div>'+
