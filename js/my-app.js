...
'<div class="row">'+
        ...
        '<div style="background-color:transparent;padding:10px;"><div id="dealtitle" style="float:left;font-weight:500;">Share on Facebook</div><div class="list-block" style="margin-top:20px;margin-bottom:10px;background-color:transparent;"><ul style="background-color:transparent;border:0;"><li><div class="item-content"><div class="item-media"><img src="http://graph.facebook.com/'+ uid +'/picture?width=20&height=20" style="margin-top:-90px;border-radius:50%;max-width:20px;"></div><div class="item-inner"><div class="item-input"><textarea id="dealbox1" placeholder="What do you think?" style="font-size:14px;background-color:white;margin-top:10px;margin-bottom:10px;border-color:#666;border-radius:5px;"></textarea><div id="postdiv"></div></div></div></div></li></ul</div></div>'+
'</div>'+
