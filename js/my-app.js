...
'<div class="row">'+
        '<div class="col-20"><a href="#" onclick="getBusiness(\''+ response[i][1]  +'\');" style="margin-left:-10px;z-index:100;float:left;margin:0 auto;border:0;background-color:transparent" class="button"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=30&height=30" style="border-radius:50%;"/></a></div>'+
