...
if ((position < (stop-1)) && (position > 0)) {$$( ".page-content" ).addClass( "page-content-scroll" );$$( "#result li:nth-child(-n+5)" ).remove();$$( '#loaded' ).css( 'width', percentage+'%' );$$( '#notloaded' ).css( 'width', minuspercentage+'%' );}
