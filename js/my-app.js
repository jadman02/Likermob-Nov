...
var staryellow = '<a href="#" onclick="removefavList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\')" id="yellow_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;width:40px;border-radius:50%;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x" style="margin-top:5px;color:#ffcc00;"></i></a>';
var starblue = '<a href="#" onclick="favList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\',\''+ response[i][16]  +'\')" id="blue_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;width:40px;border-radius:50%;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x" style="margin-top:5px;"></i></a>';
