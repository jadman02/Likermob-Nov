...
var staryellow = '<a href="#" onclick="removefavList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\')" id="yellow_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;width:40px;margin-left:-5px;border:0;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x" style="margin-top:5px;color:#ffcc00;"></i></a>';
var starblue = '<a href="#" onclick="favList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\',\''+ response[i][16]  +'\')" id="blue_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;margin-left:-5px;width:40px;border:0;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x" style="margin-top:5px;"></i></a>';


if(favEntries.length > 0){for (j = 0; j < favEntries.length; j++) {if (favEntries[j].page_id == response[i][1]){staryellow = '<a href="#" onclick="removefavList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\')" id="yellow_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;width:40px;margin-left:-5px;border:0;background-color:transparent;" class="button"><i class="pe-7s-star pe-2x" style="margin-top:5px;color:#ffcc00;"></i></a>';starblue = '<a href="#" onclick="favList(\''+ response[i][1]  +'\',\''+ response[i][2]  +'\',\''+ response[i][16]  +'\')" id="blue_'+ response[i][2] +'" style="z-index:100;margin:0 auto;clear:both;height:40px;margin-left:-5px;width:40px;border:0;background-color:transparent;" class="button hide"><i class="pe-7s-star pe-2x" style="margin-top:5px;"></i></a>';}}}
...
'<div class="row">'+
     '<div class="col-30" style="margin-top:-60px;"><div style="background-color:#c4c4c4;border-radius:10px;"><a href="#" onclick="getBusiness(\''+ page_id  +'\',\''+ name  +'\');" style="height:50px;z-index:100;margin:0 auto;border:0;background-color:transparent;" class="button"><img src="http://graph.facebook.com/'+page_id+'/picture?width=30&height=30" style="border-radius:50%;margin-top:10px;"/></a>'+staryellow + starblue+mapbutton+'<div id="loadmorebutton"></div></div> </div>'+
        '<div class="col-70">'+

    '<span class="badge" style="clear:both;float:right;margin:0 auto;margin-left:5px;background-color:#ff8000;"><i class="pe-7s-like2 pe-rotate-180" style="margin-right:2px;"></i>88</span><span class="badge" style="float:right;margin:0 auto;background-color:#3b5998;"><i class="pe-7s-like2" style="margin-right:2px;"></i>9</span>'+
        '<div class="messages-date" style="clear:both;float:left;margin:0;padding:0;"><span>Smilesavers</span></div><div style="clear:both;background-color:transparent;padding:10px;width:100%;margin-top:0px;text-align:left;"><div id="dealtitle" style="float:left;font-weight:500;"><div id="titlediv"></div></div><br/><div style="clear:both;"><div id="descriptiondiv"></div></div></div>'+
