...
'<div class="imagediv" style="margin:0 auto;width:150px;" onclick="makeComment();">'+

  '<a href="#" onclick="makeComment();" style="float:left;height:40px;width:40px;border-radius:50%;background-color:hsla(0, 0%, 100%, 0.5);" class="button"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=40&height=40" style="border-radius:50%;margin-left:-10px;"/></a>'+
'<a href="#" onclick="makeComment();" style="float:left;height:40px;width:40px;border-radius:50%;background-color:hsla(0, 0%, 100%, 0.5);" class="button"><i class="pe-7s-comment pe-3x" style="float:right;"></i></a>'+
'<a href="#" onclick="makeComment();" style="float:left;height:40px;width:40px;border-radius:50%;background-color:hsla(0, 0%, 100%, 0.5);" class="button"><i class="pe-7s-more pe-3x" style="float:right;border-right:1px solid #333;"></i></a>'+

//openBrowser();
    
  
//onclick="getBusiness(\''+ response[i][1]  +'\');"
//
//onclick="popUp(\''+ response[i][3]  +'\',\''+ singlequote  +'\',\''+ response[i][1]  +'\',\''+ response[i][2]  +'\')"
'</div>'+
'<div class="swipeout-content">'+
'<a href="#" id="getDeal"   class="item-content" style="margin-top:-50px;">'+
...
'</a>'+
   '<div class="content-block" id="content-block" style="margin-top:10px;">'+
     ...
     '<div id="dealtitle" style="float:left;clear:both;"><b>'+ response[i][3] + '</b></div><br/><div>'+response[i][4]+'</div>'+
...
function moveHomeimage(){
	...
	var positionimage = height_image - 61;
