...
'<a href="#" onclick="loadMore(\'http://smilesavers.net.au/images/compressed/'+response[i][1]+'_'+response[i][21]+'.jpg\',\''+ response[i][1]  +'\');" style="z-index:100;float:right;margin-right:5px;height:40px;width:40px;border:0;background-color:transparent;" class="button"><i class="pe-7s-more pe-2x" style="margin-left:-5px;margin-top:5px;"></i></a>'+
