...
if (post_id == '9') {$$( '#yellow_b' ).css( 'color', '#ccc');}
...
if(favEntries.length > 0){for (j = 0; j < favEntries.length; j++) {if (favEntries[j].page_id == page_id){staryellow = '<i class="pe-7s-star pe-lg button" id="yellow_b" onclick="removefavList(\''+  page_id  +'\',9)" style="border:0;color:#ffcc00;"></i>';starblue = '<i class="pe-7s-star pe-lg hide button" id="blue_b" onclick="favList(\''+ page_id  +'\',9)" style="border:0;"></i>';}}}
