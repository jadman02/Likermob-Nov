...
if (position < (stop-1)) {$$( '#result' ).append('<li id="listmarker"></li>');document.getElementById("listmarker").innerHTML = '<div style="height:5px;color:black;width:10%;';$$( ".page-content" ).removeClass( "page-content-scroll" );}
