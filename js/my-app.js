...
'<div class="imagediv" style="margin:0 auto;">'+
  ...
  '<a href="#" onclick="makeComment();" style="height:60px;width:60px;border-radius:50%;margin:0 auto;background-color:hsla(0, 0%, 100%, 0.5);" class="button"><i class="pe-7s-comment pe-3x" style="margin-top:10px;"></i></a>'+
//openBrowser();
...
'</a>'+
   '<div class="content-block" id="content-block" style="margin-top:10px;">'+
     ...
     '<div id="dealtitle" style="float:left;"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=15&height=15" style="border-radius:50%;"/><b>'+ response[i][3] + '</b></div><br/><div>'+response[i][4]+'</div>'+
