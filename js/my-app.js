...
toolbarTemplate:'<div class="toolbar tabbar"><div class="toolbar-inner"><a href="#" class="link photo-browser-prev"><i class="icon icon-prev"></i></a><i class="icon pe-7s-info pe-lg" style="color:#ff8000"></i><i class="icon pe-7s-like pe-lg" style="color:#ff8000"></i><a href="#" class="link photo-browser-next"><i class="icon icon-next"></i></a></div></div>',
