...
var itemlist = [];
for (i = 5; i < 9; i++) {itemlist.push({marker: response[i][0],title: response[i][3],page_id: response[i][1],post_id: response[i][2],photo_created: response[i][21],like: response[i][17],dislike: response[i][18],expiry: response[i][6]}); 
