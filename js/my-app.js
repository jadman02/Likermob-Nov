...
var url = 'http://smilesavers.net.au/images/compressed/'+response[0][1]+'_'+response[0][21]+'.jpg';
    ...
    title: '<img src="http://graph.facebook.com/'+page_id+'/picture?width=30&height=30" style="border-radius:50%;max-width:30px;"/><div class="messages-date" style="margin:0;padding:0;"><span>Smilesavers</span></div>',
     ...
     '<div style="margin-top:10px;" class="messages-date">Sunday, Feb 3 <span>11:58</span></div>'+ 
'<div class="row">'+
...
'</div>'+
'<div class="row">'+
        '<div style="background-color:#e5e5ea;padding:10px;padding-bottom:30px;border-radius:10px;margin-top:10px;"><div id="dealtitle" style="float:left;font-weight:500;">Terms</div>'+ terms + ' akjdakjdbakjdbaskjbs</div>'+
'</div>'+
     '<div class="row">'+
