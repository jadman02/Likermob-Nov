...
'</div>' +
    ...
    '<div class="toolbar-inner" style="background-color:transparent;border:0;">' +
          ...
          '<a href="#" class="link button button-fill" onclick="openMap();" style="width:50px;height:50px;margin:0 auto;margin-top:-50px;border-radius:50%;"><i class="pe-7s-back pe-2x" style="color:white;"></i></a>' +
