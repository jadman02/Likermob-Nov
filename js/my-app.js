...
'</a>'+
   '<div class="content-block" id="content-block" style="margin-top:-1px;clear:both;">'+
     ...
     '<div id="dealtitle" style="float:left;"><b>'+ response[i][3] + ' fklasjdl ksadjskld jsakldjs akld the best in the world</b></div><div style="float:right;font-size:14px;"><i class="pe-7s-cloud-upload pe-lg"></i> Uploaded 6 minutes ago</div><br/><div style="clear:both;">'+response[i][4]+'</div>'+
