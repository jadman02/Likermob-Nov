...
'<div id="map-canvas"></div>' +
        ...
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);"">' +
	      '<div class="list-block media-list" style="margin-top:0px;"><ul style="background-color:hsla(0, 0%, 100%, 0.8);"><div id="cover-div"></div><div id="info-here"></div><li style="width:50%;float:left;"><a href="#" onclick="openLikez()" class="item-content" style="color:#666;"><div class="item-media" style="margin-left:30px;"><i class="pe-7s-like2 pe-lg" style="margin-right:5px;"></i></div><div class="item-inner"><div class="item-title-row"><div class="item-title"></div><div class="item-after"><div id="after-liked" class="badge" style="color:#666;background-color:transparent;"></div></div></div></div></a></li><li style="width:50%;float:left;"><a href="#" onclick="openLikex()" class="item-content" style="color:#666;"><div class="item-media" style="margin-left:30px;"><i class="pe-7s-like2 pe-lg pe-rotate-180" style="margin-right:5px;"></i></div><div class="item-inner"><div class="item-title-row"><div class="item-title"></div><div class="item-after"><div id="after-notliked" class="badge" style="color:#666;background-color:transparent;"></div></div></div></div></a></li><div id="my"><div id="like-deals-here"></div></div><div id="nomy"><div id="deals-here"></div></div></ul></div>' +
