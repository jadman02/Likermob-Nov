...
'<a href="#" style="clear:both;" class="button" onclick="getBusiness(\''+ response[i][1]  +'\');"><img src="http://graph.facebook.com/'+response[i][1]+'/picture?width=30&height=30" style="border-radius:50%;height:40px;width:40px;padding-top:5px;float:left;"/></a>'+
'</div>'+
