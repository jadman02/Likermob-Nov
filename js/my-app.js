...
myApp.modal({
     ...
     text: '<div class="content-block modal-block" style="padding:0;margin:0;height:350px;border:0;overflow: scroll;overflow-x:hidden;"><div class="content-block-inner" style="background-color:transparent;border:0;"><div id="likebuttons"><span class="badge" style="clear:both;float:right;margin-left:5px;background-color:#ff8000;"><i class="pe-7s-like2 pe-rotate-180" style="margin-right:2px;"></i><div id="dislikeround" style="float:right;"></div></span><span class="badge" style="float:right;background-color:#3b5998;"><i class="pe-7s-like2" style="margin-right:2px;"></i><div id="likeround" <div id="loadmorebutton"></div>></div></span></div><div class="modal_inner" style="background-color:white;">'+
'<div class="row">'+
