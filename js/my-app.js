...
myApp.modal({
    ...
    text: '<div class="content-block" style="padding:0;margin:0;max-height:200px;overflow: scroll;"><div class="content-block-inner">' + title + ' <img style="clear:both;margin-top:10px;margin-bottom:-10px;width:50%;" src="'+ url +'"/></div></div>',
